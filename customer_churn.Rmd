...
The raw data contains 7043 rows (customers) and 21 columns (features). The Churn column is our target. Well use all other columns as features to our model.
...
The minimum tenure is 1 month and maximum tenure is 72 months, we can group them into five tenure groups: 12 Month, 12-24 Month, 24-48 Months, 48-60 Month, > 60 Month.
